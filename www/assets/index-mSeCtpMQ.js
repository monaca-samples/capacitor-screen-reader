...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web-uChSfreQ.js"), true ? __vite__mapDeps([]) : void 0, import.meta.url).then((m) => new m.SplashScreenWeb())
});
var CameraSource;
...
const Camera = registerPlugin("Camera", {
  web: () => __vitePreload(() => import("./web-1KFiDZsH.js"), true ? __vite__mapDeps([]) : void 0, import.meta.url).then((m) => new m.CameraWeb())
});
